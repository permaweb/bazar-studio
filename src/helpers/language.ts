...
export const language = {
	en: {
		...
		coverArtUploaded: `Cover art uploaded`,
		coverArtRemoved: `Cover art removed`,
		coverArtRequired: `Cover art is required for audio files`,
		coverArtOptional: `Cover art is optional but recommended for audio files`,
	},
};
